...
export const guides: Guide[] = [
  {
    ...
    category: "신청 가이드",
    description: "지원대상, 소득 기준, 지역 조건, 신청 기간을 빠르게 확인하는 기본 절차입니다.",
    readingTime: "5분",
    sections: [
      { heading: "공식 출처부터 확인", body: "민간 사이트의 설명은 탐색을 돕는 역할입니다. 최종 자격과 신청은 정부24, 복지로, K-Startup, 고용센터 등 공식 출처에서 반드시 확인해야 합니다." },
      { heading: "나의 조건을 먼저 정리", body: "나이, 거주지역, 가구상황, 소득구간, 고용상태, 사업자 여부를 정리하면 검색 결과를 크게 줄일 수 있습니다." },
      { heading: "마감일을 우선순위로 보기", body: "지원금은 예산 소진이나 접수 기간 종료로 놓치기 쉽습니다. 마감임박 정책과 상시 정책을 분리해서 보는 것이 좋습니다." }
    ]
  },
  {
    ...
    readingTime: "4분",
    sections: [
      { heading: "연령 기준", body: "정책별 청년 기준은 만 19세부터 34세까지가 많지만, 지자체와 사업별로 39세까지 확장되는 경우도 있습니다." },
  ...
  },
  {
    ...
    category: "SEO",
    description: "사용자 질문 단위로 제목, 요약, 상세, 공식 링크를 정리하는 방법입니다.",
    readingTime: "5분",
    sections: [
      { heading: "검색 의도별 랜딩", body: "청년 월세, 소상공인 자금, 출산 지원금처럼 검색 의도가 분명한 주제는 별도 랜딩으로 운영하는 것이 좋습니다." },
