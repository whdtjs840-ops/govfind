...
export const publicApiSources = [
  {
    ...
    purpose: "부처·지자체·공공기관 혜택 카탈로그의 상위 모수 확보",
    fields: "서비스명, 기관명, 분류, 상세, 기관 코드, 공식 링크",
    endpoint: "api.odcloud.kr gov24 list/details"
  },
  {
    name: "중앙부처 복지서비스",
    provider: "한국사회보장정보원·복지로",
    purpose: "전국 단위 복지 서비스 목록과 상세 탐색",
    fields: "생애주기, 대상, 관심주제, 나이, 온라인 신청, 정렬",
    endpoint: "apis.data.go.kr NationalWelfarelist"
  },
  {
    name: "지자체 복지서비스",
    provider: "한국사회보장정보원",
    purpose: "지역별 지원금과 복지서비스 매칭 정밀화",
    fields: "시도, 시군구, 대상, 관심주제, 검색어, 정렬",
    endpoint: "apis.data.go.kr LcgvWelfarelist"
  },
  {
    name: "K-Startup 지원사업",
    provider: "창업진흥원",
    purpose: "예비창업자와 초기기업 대상 공고 확장",
    fields: "사업명, 사업유형, 모집기간, 신청방법, 문의처",
    endpoint: "data.go.kr K-Startup Swagger"
  }
];
